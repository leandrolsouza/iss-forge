      ...
      <div className="about-content">
        ...
        <div className="about-header">
          <div className="about-logo">
            <svg width="64" height="64" viewBox="0 0 512 512">
              ...
              <path d="M256 155 L273 173 L267 195 L245 195 L239 173 Z" fill="#2c3e50" opacity="0.8" />
              <path d="M285 181 L303 192 L301 215 L285 221 L273 208 Z" fill="#2c3e50" opacity="0.7" />
              <path d="M227 181 L209 192 L211 215 L227 221 L239 208 Z" fill="#2c3e50" opacity="0.7" />
              <text x="256" y="360" fontFamily="Arial, sans-serif" fontSize="48" fontWeight="900" fill="#fff" textAnchor="middle">ISS</text>
              <text x="256" y="400" fontFamily="Arial, sans-serif" fontSize="32" fontWeight="700" fill="#2ecc71" textAnchor="middle">FORGE</text>
            </svg>
          </div>
          <h1 className="about-title">ISS Forge <span className="beta-badge">BETA</span></h1>
          <p className="about-version">v0.1.0-beta</p>
          <p className="about-description">
            ROM Editor for International Superstar Soccer<br />
            Super Nintendo Entertainment System (1995)
          </p>
          <p className="about-beta-notice">
            Esta é uma versão beta. Algumas funcionalidades ainda estão sendo refinadas.<br />
          ...
          <div className="about-author-card">
            ...
            <div className="about-author-info">
              ...
              <div className="about-author-links">
                <button className="about-link" onClick={() => openLink('https://www.linkedin.com/in/leandrolsouza/')}>
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
                    <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 1.146H1.175C.526 16 0 15.487 0 14.854V1.146zm4.943 12.248V6.169H2.542v7.225h2.401zm-1.2-8.212c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 0-1.359.54-1.359 1.248 0 .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 0 1.216.662 1.216 1.634v3.865h2.401V9.25c0-2.22-1.184-3.252-2.764-3.252-1.274 0-1.845.7-2.165 1.193v.025h-.016l.016-.025V6.169h-2.4c.03.678 0 7.225 0 7.225h2.4z" />
                  </svg>
                  LinkedIn
                </button>
                <button className="about-link" onClick={() => openLink('https://github.com/leandrolsouza')}>
                  <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor">
        ...
        <div className="about-section">
          ...
          <div className="about-credits">
            ...
            <ul>
              <li><strong>Rodrigo Mallmann Guerra</strong> — ISS Studio (Java)</li>
              <li><strong>Esteban Fuentealba</strong> — Web ISS Studio (Vue/WASM)</li>
              <li><strong>ProtonNoir</strong> — Konami SNES Compressor/Decompressor</li>
              <li><strong>Equipe Puma</strong> — ROM offset maps & research</li>
              <li><strong>Equipe Falcon Brasil</strong> — Testing & documentation</li>
            </ul>
          </div>
        </div>
